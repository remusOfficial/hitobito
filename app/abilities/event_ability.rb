...
class EventAbility < AbilityDsl::Base
  ...
  on(Event) do
    ...
    permission(:layer_full).
      may(:index_participations, :update, :create, :destroy, :application_market, :qualify, :qualifications_read).
      in_same_layer
    ...
    general(:create, :destroy, :application_market, :qualify, :qualifications_read).at_least_one_group_not_deleted
  end
